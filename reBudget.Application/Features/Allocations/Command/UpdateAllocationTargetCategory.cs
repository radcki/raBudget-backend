        ...
        public class Handler : IRequestHandler<Command, Result>
        {
            ...
            public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                var oldBudgetCategory = await _writeDbContext.BudgetCategories
                                                             .FirstAsync(x => x.BudgetCategoryId == transaction.TargetBudgetCategoryId, cancellationToken: cancellationToken);
                ...
                transaction.SetTargetBudgetCategory(newBudgetCategory);

                await _writeDbContext.SaveChangesAsync(cancellationToken);

                return new Result()
                       {
                           Id = transaction.TargetBudgetCategoryId
                       };
            }
        }
    }
