...
namespace raBudget.Api.ApiControllers
{
    ...
    public class BudgetCategoriesController : ControllerBase
    {
        ...
        [HttpPatch("update/hidden")] public async Task<UpdateBudgetCategoryVisibility.Result> UpdateBudgetCategoryVisibility([FromBody] UpdateBudgetCategoryVisibility.Command command) => await _mediator.Send(command);
