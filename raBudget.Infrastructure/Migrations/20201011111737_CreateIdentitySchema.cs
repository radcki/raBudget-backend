...
namespace raBudget.Infrastructure.Migrations
{
    public partial class CreateIdentitySchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurrencyCodeCode = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Currency", x => x.CurrencyCodeCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data = table.Column<string>(maxLength: 127, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyCodeCode = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Budgets", x => x.BudgetId);
                    table.ForeignKey(
                        name: "FK_Budgets_Currency_CurrencyCodeCode",
                        column: x => x.CurrencyCodeCode,
                        principalTable: "Currency",
                        principalColumn: "CurrencyCodeCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_CurrencyCodeCode",
                table: "Budgets",
